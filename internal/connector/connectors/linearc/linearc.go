...
var datasets = map[string]datasetDef{
	"issues": {
		root:   "issues",
		selSet: "id identifier title priority createdAt updatedAt url state { name } assignee { name } team { key }",
		fields: []field{
	...
	"teams": {
		root:   "teams",
		selSet: "id key name description createdAt",
		fields: []field{
			{"id", []string{"id"}, engine.TypeString},
	...
	"projects": {
		root:   "projects",
		selSet: "id name state progress startDate targetDate createdAt",
		fields: []field{
			{"id", []string{"id"}, engine.TypeString},
			{"name", []string{"name"}, engine.TypeString},
	...
	"users": {
		root:   "users",
		selSet: "id name displayName email active admin createdAt",
		fields: []field{
			{"id", []string{"id"}, engine.TypeString},
			{"name", []string{"name"}, engine.TypeString},
